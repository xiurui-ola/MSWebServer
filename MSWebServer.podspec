...
Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/xiurui-ola/MSWebServer'
  s.summary  = 'Lightweight GCD based HTTP server for OS X & iOS (includes web based uploader & WebDAV server)'
  
  s.source   = { :git => 'https://github.com/xiurui-ola/MSWebServer.git', :tag => s.version.to_s }
  ...
  s.subspec 'Core' do |cs|
    cs.source_files = 'MSWebServer/**/*.{h,m}'
    cs.private_header_files = "MSWebServer/Core/MSWebServerPrivate.h"
  ...
  s.subspec 'WebDAV' do |cs|
    cs.dependency 'MSWebServer/Core'
